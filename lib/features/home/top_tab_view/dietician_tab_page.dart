...
class DieticianTabPage extends StatefulWidget {
  const DieticianTabPage({super.key});

  @override
  State<DieticianTabPage> createState() => _DieticianTabPageState();
}

class _DieticianTabPageState extends State<DieticianTabPage> {
  List data = [
    {
      "name": "Sayed Mostafa",
